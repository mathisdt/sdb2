 ...
 * <p>
 * On the contrary to {@link NGramTokenFilter}, this class sets offsets so
...
public class NGramTokenizer extends Tokenizer {
	 ...
	 * 
	 * @param factory
	 *            {@link org.apache.lucene.util.AttributeFactory} to use
	 * @param minGram
	 *            the smallest n-gram to generate
	 * @param maxGram
	 *            the largest n-gram to generate
	...
	private void init(@SuppressWarnings("hiding") int minGram, @SuppressWarnings("hiding") int maxGram,
		...
		charBuffer = CharacterUtils.newCharacterBuffer(2 * maxGram + 1024); // 2 * maxGram in case all code points
																			// require 2 chars and + 1024 for buffering
																			// to not keep polling the Reader
