...
public final class AnalysisSPILoader<S extends AbstractAnalysisFactory> {
	 ...
	 * 
	 * <p>
	 * <b>NOTE:</b> Only new service providers are added, existing ones are
	...
	/**
	 * Creates a new instance of the given {@link AbstractAnalysisFactory} by invoking the constructor, passing the
	 * given argument map.
	 */
