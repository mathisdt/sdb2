 ...
 * <li>(Optional) If the factory uses resources such as files, {@link ResourceLoaderAware#inform(ResourceLoader)} is
 * called to initialize those resources.
...
public abstract class AbstractAnalysisFactory {
	...
	protected final Pattern getPattern(Map<String, String> args, String name) {
		try {
			...
			throw new IllegalArgumentException("Configuration Error: '" + name + "' can not be parsed in " +
