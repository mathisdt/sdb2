 ...
 */
package org.zephyrsoft.sdb2.util.repackaged.lucene.analyzers.common;

import static org.zephyrsoft.sdb2.util.repackaged.lucene.analyzers.common.AnalysisSPILoader.newFactoryClassInstance;
...
public final class CustomAnalyzer extends Analyzer {
	...
	public static final class Builder {
		 ...
		 * 
		 * @param name
		 *            is used to look up the factory with {@link TokenizerFactory#forName(String, Map)}.
		 ...
		 * 
		 * @param factory
		 *            class that is used to create the token filter.
		 * @param params
		 *            a list of factory string params as key/value pairs.
		 *            The number of parameters must be an even number, as they are pairs.
		 */
		 ...
		 * 
		 * @param name
		 *            is used to look up the factory with {@link TokenFilterFactory#forName(String, Map)}.
		 *            The list of possible names can be looked up with
		 *            {@link TokenFilterFactory#availableTokenFilters()}.
		 * @param params
		 *            a list of factory string params as key/value pairs.
		 *            The number of parameters must be an even number, as they are pairs.
		 */
		 ...
		 * 
		 * @param factory
		 *            class that is used to create the char filter.
		 * @param params
		 *            a list of factory string params as key/value pairs.
		 *            The number of parameters must be an even number, as they are pairs.
		 */
		 ...
		 * 
		 * @param name
		 *            is used to look up the factory with {@link CharFilterFactory#forName(String, Map)}.
