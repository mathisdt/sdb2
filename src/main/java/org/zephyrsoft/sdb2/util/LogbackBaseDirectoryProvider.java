...
/**
 * Provides the base directory which can be changed through the "--logs ..." command line parameter.
 *
 ...
 */
public class LogbackBaseDirectoryProvider implements PropertyDefiner {
